...
class AeroSurface:
    def __init__(self, Al, C_a_b, r_a):
        ...
        self.aTable  = np.array([-180,-135,-90,-60,-45,-30,-15,-10,-5,
                                 0,5,10,15,30,45,60,90,135,180])
        self.ClTable = np.array([   0.0,-0.25,0.00,-0.01,-0.1,-.025,-0.95, -0.75, -0.6,
                                    0,0.5,0.75, 0.99,0.5,0.25,0.01,0.0,0.25,0.0]) 
        self.CdTable = np.array([0.01,0.5,1.0, 0.8, 0.75, 0.5, 0.1, 0.05, 0.025,
                                 0.01, 0.025, 0.05, 0.1, 0.5, 0.75, 0.8, 1.0, 0.5,0.01])
